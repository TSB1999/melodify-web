...
export function MediaRecommendCard() {
    ...
    return (
        <Carousel indicators={false} >
            {
                UserStore.recommend.map(item => <Carousel.Item interval={500} style={{ paddingLeft: '10px', paddingRight: '10px' }}><Card className={classes.root}>
                    <div className={classes.details}>
                        <CardContent className={classes.content}>
                            ...
                            <h6 style={{ textAlign: 'center', backgroundColor: '#007bff', color: 'white', padding: '5px', borderRadius: '10px' }}>{item.artistName}</h6>
                        </CardContent>
...
export default observer(MediaRecommendCard)
